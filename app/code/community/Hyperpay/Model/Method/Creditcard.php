 ...
 *
 */
class Hyperpay_Model_Method_Creditcard extends Hyperpay_Model_Method_Abstract
{
    ...
    protected $_formBlockType = 'hyperpay/payment_form_creditcard';
